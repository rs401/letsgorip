...
func (c *placeServiceClient) UpdatePlace(ctx context.Context, in *Place, opts ...grpc.CallOption) (*PlaceIdResponse, error) {
	out := new(PlaceIdResponse)
...
func (UnimplementedPlaceServiceServer) UpdatePlace(context.Context, *Place) (*PlaceIdResponse, error) {

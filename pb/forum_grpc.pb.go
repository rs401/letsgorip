...
type ForumServiceClient interface {
	...
	GetThreads(ctx context.Context, in *GetThreadsRequest, opts ...grpc.CallOption) (ForumService_GetThreadsClient, error)
...
func (c *forumServiceClient) GetThreads(ctx context.Context, in *GetThreadsRequest, opts ...grpc.CallOption) (ForumService_GetThreadsClient, error) {
...
type ForumServiceServer interface {
	...
	GetThreads(*GetThreadsRequest, ForumService_GetThreadsServer) error
...
func (UnimplementedForumServiceServer) GetThreads(*GetThreadsRequest, ForumService_GetThreadsServer) error {
